...
(custom-set-variables
 ...
 '(org-capture-templates
   (quote
	...
	%^{Payer|Acccounts:BHP Credit|Assets:BHP Checking|Assets:Cash|Assets:Ally Checking|Accounts:Credit Cards:Discover|Accounts:Bankroll|Accounts:Poker}" :empty-lines 1))))
